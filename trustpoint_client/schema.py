...
class DomainConfigModel(BaseModel):
    ...
    pki_protocol: PkiProtocol = ...  # type: ignore[assignment]
    tls_trust_store: str = ...  # type: ignore[assignment]
...
class CredentialModel(BaseModel):
    ...
    unique_name: str = ...  # type: ignore[assignment]
...
class DomainModel(BaseModel):
    ...
    ldevid_credential: CredentialModel = ...  # type: ignore[assignment]
